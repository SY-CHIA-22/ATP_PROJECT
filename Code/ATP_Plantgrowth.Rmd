...
# Data analysis
## Leaf Area data:  run the selected model
...
```{r}
HSD_test <- emmeans(ref_grid(f2, regrid = "response"), pairwise ~ amendment1)
emmeans(ref_grid(f2, regrid = "response"), pairwise ~ amendment1) 


```
# Plots for leafarea. cm
