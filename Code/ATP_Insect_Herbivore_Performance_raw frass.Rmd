...
DFE1$percent_per_day1 <- as.numeric(DPW2$percent_per_day1)
...
DFE2$percent_per_day2 <- as.numeric(DPW2$percent_per_day2)
...
shapiro.test(DPR1$tot_larv_pupa1)
shapiro.test(DPR2$tot_larv_pupa2)

shapiro.test(DPW1$pupalweight1)
shapiro.test(DPW2$pupalweight2)

shapiro.test(DFE1$percent_per_day1)
shapiro.test(DFE2$percent_per_day2)
...
glmp.DPR1 <- glm(tot_larv_pupa1 ~ amendment1, family = poisson, data = DPR1)
gamma.DPR1 <- glm(tot_larv_pupa1 ~ amendment1, family = Gamma(link = "log"), data = DPR1)
glm.DPR1 <- glm(tot_larv_pupa1 ~ amendment1, data = DPR1)
AIC(lm.DPR1, glmp.DPR1, gamma.DPR1, glm.DPR1)

# Check overdispersion. The ratio should be around 1
Overdisp_fun(glmp.PPR1)

lm.DPR2 <- lm(tot_larv_pupa2 ~ amendment2, data = DPR2)
glmp.DPR2 <- glm(tot_larv_pupa2 ~ amendment2, family = poisson, data = DPR2)
gamma.DPR2 <- glm(tot_larv_pupa2 ~ amendment2, family = Gamma(link = "log"), data = DPR2)
glm.DPR2 <- glm(tot_larv_pupa2 ~ amendment2, data = DPR2)
AIC(lm.DPR2, gamma.DPR2, glm.DPR2)
...
gamma.DFE1 <- glm(percent_per_day1 ~ amendment1, family = Gamma(link = "log"), data = DFE1)
glm.DFE1 <- glm(percent_per_day1 ~ amendment1, data = DFE1)
AIC(lm.DFE1, gamma.DFE1, glm.DFE1)

lm.DFE2 <- lm(percent_per_day2 ~ amendment2, data = DFE2 )
gamma.DFE2 <- glm(percent_per_day2 ~ amendment2, family = Gamma(link = "log"), data = DFE2)
glm.DFE2 <- glm(percent_per_day2 ~ amendment2, data = DFE2)
AIC(lm.DFE2, gamma.DFE2, glm.DFE2)
