...
# Raw Frass: Analyse leaf area and leaf number (repeated measures) separately, i.e., for each time point (21, 28, 35 and 42 days since germination).

By day 35 - 42, the negative effect of Mealworm frass had disappeared

## Plots *leafarea1* - Trial 1
...
boxplot(leafarea1 ~ amendment1, data = subset_LA1,
        main = paste("Plant age (days) =", time_val),
...
## Plots for time points 21, 28 and 35 
(Raw Frass)
...
p_42 <- ggplot(subset_LA1, aes(amendment1, leafarea1))+ 
  ...
  stat_summary(fun = mean, geom = "point", col = "white", shape = 12) +
 stat_summary(fun = mean, geom = "point", col = "white") +
  labs(title = paste("Plant age (days) =", time_val),
...
## Analysis (GLM) - *Leafarea1* (Raw Frass)
...
#Raw Frass
##Analyse *leaf area 2* (repeated measures) separately, i.e., for each time point (21, 28, 35 and 42 days since germination).
...
## Analysis (GLM) - *Leafarea2* (Raw Frass)
...
#RawFrass:LeafNumber, Trial 1
Analyse leafnumber (repeated measures) separately, i.e., for each time point (21, 28, 35 and 42 days since germination).
...
## Analysis (GLM) - *LeafNumber1* (Raw Frass)
